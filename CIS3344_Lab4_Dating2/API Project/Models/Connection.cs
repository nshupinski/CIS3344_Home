...
namespace API_Project.Models
{
    public class DBConnect
    {
        ...
        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp20_3344_tuj77546;User id=tuj77546;Password=pi3Noghaiw";

        // Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1,5555;Database=sp20_3344_tuj77546;User id=tuj77546;Password=pi3Noghaiw";
